...
# CODUL TĂU VINE MAI JOS:
print(age % age2 % age3 ) # NU PREA AM INTELES SARCINA :(
# CODUL TĂU VINE MAI SUS:
...
# Acum afișează rezultatul vârstei primului prieten împărțită la puterea vârstei 
# celui de-al doilea prieten folosind funcția `print`
# CODUL TĂU VINE MAI JOS:
print(age / (age2 ** 2))
# CODUL TĂU VINE MAI SUS:
